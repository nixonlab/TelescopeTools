# Getting help with `TelescopeTools`

Thank you for using `TelescopeTools`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/TelescopeTools`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/TelescopeTools),
...
[search issues and pull requests](https://github.com/nixonlab/TelescopeTools/issues)
