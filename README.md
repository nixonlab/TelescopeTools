...
[![R-CMD-check-bioc](https://github.com/nixonlab/TelescopeTools/actions/workflows/R-CMD-check-bioc.yaml/badge.svg)](https://github.com/nixonlab/TelescopeTools/actions/workflows/R-CMD-check-bioc.yaml)
[![Codecov test
coverage](https://codecov.io/gh/nixonlab/TelescopeTools/branch/main/graph/badge.svg)](https://app.codecov.io/gh/nixonlab/TelescopeTools?branch=main)
<!-- badges: end -->

The goal of `TelescopeTools` is to …
...
#>   }
#> 
#>   Bendall ML (2023). "TelescopeTools." _bioRxiv_. doi:10.1101/TODO
